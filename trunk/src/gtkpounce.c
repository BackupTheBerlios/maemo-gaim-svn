						   ...
						   GaimPounce *cur_pounce)
{
...
#ifdef ENABLE_HILDON
    gtk_widget_set_size_request(window, 600, 350);
#endif
#endif
...
#ifdef GAIM_SMALL_SCREEN
    vbox2 = frame = gaim_gtk_make_frame (notebook, "");
    gtk_widget_show (frame);
    label = gtk_label_new (_("Pounce Who"));
    ...
    vbox2 = frame = gaim_gtk_make_frame (notebook, "");
    gtk_widget_show (frame);
    label = gtk_label_new (_("Pounce When"));
    gtk_widget_show (label);
    ...
    vbox2 = frame = gaim_gtk_make_frame (notebook, "");
    gtk_widget_show (frame);
    label = gtk_label_new (_("Pounce Action"));
    gtk_widget_show (label);
